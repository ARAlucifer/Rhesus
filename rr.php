...
<head>
  ...
  <title>Rhesus -Recipient reg</title>
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="dr.php">Donor Registration</a></li>
          <li><a class="nav-link scrollto active" href=rr.php>Recipient Registration</a></li>
          <li><a class="nav-link scrollto " href="#services">Blood Bank Registration</a></li>
       
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="#about" class="get-started-btn scrollto">Team Rhesus</a>
            ...
            <div class="form-holder">
              <div class="form-content">
                <div class="form-items">
                  <h3>We need some information to help you!</h3>
                  ...
                  <form name="myform" action="connect.php" method="post">
                    ...
                    <div class="col-md-12 mt-3">
                      ...
                      <label class="btn btn-sm btn-outline-secondary" for="secret">Transgender</label>

                    </div>

                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="invalidCheck" required>
                      <label>I confirm that all the data provided above is correct. </label><br>
